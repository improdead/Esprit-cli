...
lint:
	...
	poetry run pylint esprit/ --score=no --reports=no
...
security:
	...
	poetry run bandit -r esprit/ -c pyproject.toml
...
test-cov:
	...
	poetry run pytest -v --cov=esprit --cov-report=term-missing --cov-report=html
