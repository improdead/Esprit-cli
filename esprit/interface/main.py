...
def parse_arguments() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Esprit Multi-Agent Cybersecurity Penetration Testing Tool",
...
Examples:
  ...
  esprit --target https://github.com/user/repo
  esprit --target git@github.com:user/repo.git

  # Local code analysis
  esprit --target ./my-project

  # Domain penetration test
  esprit --target example.com

  # IP address penetration test
  esprit --target 192.168.1.42

  # Multiple targets (e.g., white-box testing with source and deployed app)
  esprit --target https://github.com/user/repo --target https://example.com
  esprit --target ./my-project --target https://staging.example.com --target https://prod.example.com

  # Custom instructions (inline)
  esprit --target example.com --instruction "Focus on authentication vulnerabilities"

  # Custom instructions (from file)
  esprit --target example.com --instruction ./instructions.txt
  esprit --target https://app.com --instruction /path/to/detailed_instructions.md
        """,
    )
